...
#import "DDQMyCommentModel.h"
#import "DDQGroupArticleModel.h"
#import "DDQUserCommentViewController.h"
#import "ProjectNetWork.h"

@interface DDQFirstChildViewController () <UITableViewDataSource,UITableViewDelegate,MyCommentCellDelegate>
...
@property (strong, nonatomic) DDQMyCommentModel *myCommentModel;
...
@implementation DDQFirstChildViewController
//static int num = 2;
- (MBProgressHUD *)hud {
...
- (void)requestDataWith:(NSInteger )page url:(NSString *)url{
    ...
    //type = 2表示评论
    [self.netWork asyPOSTWithAFN_url:url andData:@[[[NSUserDefaults standardUserDefaults] valueForKey:@"userId"], @"2", @(page).stringValue] andSuccess:^(id responseObjc, NSError *code_error) {
