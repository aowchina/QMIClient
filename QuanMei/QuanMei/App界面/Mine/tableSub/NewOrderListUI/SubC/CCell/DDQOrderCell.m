...
//    }
    ...
    NSString *name_str = [NSString stringWithFormat:@"【%@】%@",model.name,model.fname];
    ...
    CGRect hospital_rect = [hosital boundStringRect_size:CGSizeMake(kScreenWidth - (kScreenWidth * 0.25 - 50), 1000) Attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14.5]}];
    ...
    CGFloat temp_h = name_rect.size.height + hospital_rect.size.height + 35;
    ...
    if (temp_h > kScreenWidth * 0.25) {
        ...
        self.cell_h = 10 + 20 + 10 + 10 + temp_h + 15 + 20;
        
    } else {
        
        self.cell_h = 10 + 20 + 10 + 10 + kScreenWidth * 0.25 + 15 + 20;
