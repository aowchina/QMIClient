...
- (void)layoutSubviews {
    ...
    CGRect order_rect = [self.order boundStringRect_size:CGSizeMake(kScreenWidth - time_rect.size.width - 30, time_rect.size.height) Attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12.5f]}];
