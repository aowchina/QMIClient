...
- (void)layoutSubviews {
    ...
    [self.state_label mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(self.evaluate_button.mas_left).offset(-10);
        make.height.equalTo(self.evaluate_button.mas_height);
        make.width.equalTo(self.evaluate_button.mas_width);
        make.centerY.equalTo(self.evaluate_button.mas_centerY);
    ...
    CGFloat temp_h = d_rect.size.height + h_rect.size.height + 25;
    if (temp_h > kScreenWidth * 0.25) {
        ...
        self.cell_h = 10 + 20 + 10 + 10 + kScreenWidth * 0.25 + 15 + 20 + 5 + 65;
