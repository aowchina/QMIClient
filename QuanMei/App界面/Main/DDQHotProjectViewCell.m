...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.oldPrice.font = [UIFont boldSystemFontOfSize:10];
...
{
    [self.modelImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.simg]]];
    ...
    NSAttributedString *string = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"￥%@",model.oldval] attributes:@{NSStrikethroughStyleAttributeName:@(NSUnderlineStyleSingle)}];
    
    //    self.oldPrice.text = [NSString stringWithFormat:@"￥%@",model.oldval];
