...
#define APP_ID          @"wx719c1e4eebfb3fb7"               //APPID
#define APP_SECRET      @"b931d772cbf4ad7d1330779dc054108d" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1311715801"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"qazwsxedcrfvtgbyhnujmikolp123456"
//支付结果回调页面
